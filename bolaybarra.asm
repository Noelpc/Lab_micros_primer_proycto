...
section .data
        ...
        posicion_in: db 0x1b,'[00;00H' 
        pos_leng: equ $-posicion_in

        bolita: db 0x1b, '[1m',111
        bolita_leng: equ $-bolita

        imp_espacio: db 0x1b, "[1C"
        imp_espacio_leng: equ $-imp_espacio

        y: db 0x1b, "[1E"
        y_leng: equ $-y
	
	linea: db 0x1b,"[1;34m",'================',0xa 
...
call echo_off
mov r10,15
;Constantes de ubicación, 55 en x, 40 en y. Se utilizan como límites
mov r13, 55
mov r12, 40
syscall
...
_ini_count:
	mov r15,1 					;cuenta pata y
	mov r14,1					;cuenta para x
	syscall
_mov_y:
	cmp r15,r12 
	je _mov_x
